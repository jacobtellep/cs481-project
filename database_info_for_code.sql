...
INSERT INTO `material_pricing` (`part_id`, `part_name`, `description`, `price`, `cost`, `part_group`) VALUES (NULL, 'HOM220', '2 Pole 20 Amp Breaker ', '10.59', '9.00', 'breakers'), (NULL, 'LA36350', '3P 350 Amp 1 Line Breaker', '1851.85', '1111.11', 'breakers')


INSERT INTO `material_pricing` (`part_id`, `part_name`, `description`, `price`, `cost`, `part_group`) VALUES (NULL, '3/4\" X 10\'', '3/4\" x 10\' Ground Rod', '25.15', '21.37', 'grounding'), (NULL, '30774', 'Green Ground Pigtail', '0.26', '0.21', 'grounding'), (NULL, '3904', '2-1/2 to 3-1/2 Ground Clamp', '61.87', '48.87', 'grounding'), (NULL, '5/8\" Ground Clamp', '5/8\" Direct Bury Ground Rod Clamp', '1.19', '1.13', 'grounding'), (NULL, '5/8\" x 8\' Grnd Rod', '5/8\" x 8\' Ground Rod', '10.67', '10.45', 'grounding'), (NULL, '90627', '1/2 to 1 Ground Clamp', '2.07', '1.63', 'grounding')

INSERT INTO `material_pricing` (`part_id`, `part_name`, `description`, `price`, `cost`, `part_group`) VALUES (NULL, 'BURGCRT1/0', '1/2 to 3/4 Ground Rod Clamp', '1.77', '1.50', 'grounding'), (NULL, 'BURGRC34', 'Ground Rod Clamp 3/4\"', '2.52', '2.13', 'grounding'), (NULL, 'BURGRC58', '5/8 Ground Rod Clamp', '1.85', '1.10', 'grounding'), (NULL, 'LIN613480', 'Ground Rod 3/4\" x 8\'', '20.46', '17.38', 'grounding'), (NULL, 'LIN615800', 'Ground Rod 5/8\" X 10\' Copper', '19.42', '16.50', 'grounding'), (NULL, 'LIN615880', 'Ground Rod 5/8 x 8\'', '15.03', '12.77', 'grounding')


INSERT INTO `material_pricing` (`part_id`, `part_name`, `description`, `price`, `cost`, `part_group`) VALUES (NULL, '208', '3 Inch Watertight Hub', '29.37', '23.20', 'hubs'), (NULL, 'C-HDS075H1', 'Hub 3/4\" WP', '8.19', '6.95', 'hubs'), (NULL, 'C-HDS150H1', 'Hub 1-1/2\"', '12.08', '9.54', 'hubs'), (NULL, 'C-HDS200H1', 'Hub 1\" WP', '12.57', '10.67', 'hubs'), (NULL, 'C-HDS200H2', 'HUB 2\" Wp 08/03/09', '10.18', '8.04', 'hubs'), (NULL, 'ECHS100', '1\" Hub', '8.01', '6.33', 'hubs')

INSERT INTO `material_pricing` (`part_id`, `part_name`, `description`, `price`, `cost`, `part_group`) VALUES (NULL, 'ECHS125', '1-1/4 Hub', '8.56', '6.76', 'hubs'), (NULL, 'ECHS200', '2\" Hub for Panel', '6.79', '5.77', 'hubs'), (NULL, 'G-ETC100', '1\" Universal Hub', '6.91', '5.87', 'hubs'), (NULL, 'G-ETC125', '1-1/4 Universal Hub', '6.05', '5.14', 'hubs'), (NULL, 'G-ETC150', '1-1/2 Universal Hub', '10.60', '8.83', 'hubs'), (NULL, 'G-ETC200', '2\" Universal Hub', '6.80', '6.20', 'hubs')

INSERT INTO `material_pricing` (`part_id`, `part_name`, `description`, `price`, `cost`, `part_group`) VALUES (NULL, 'G-ETC75', '3/4 Universal Hub', '6.45', '5.48', 'hubs'), (NULL, 'H125-TB', '1 1/4 Myers Hub ', '8.94', '7.06', 'hubs'), (NULL, 'MYEST1', '1/2 Zinc Ins Hub', '5.24', '4.44', 'hubs'), (NULL, 'MYEST10', '4-In Zinc Ins Hub', '41.16', '34.98', 'hubs'), (NULL, 'MYEST2', '3/4\" Zinc Ins Hub', '6.52', '5.15', 'hubs'), (NULL, 'Hubs:MYEST3', '1\" Zinc Ins Hub', '6.37', '5.03', 'hubs')
